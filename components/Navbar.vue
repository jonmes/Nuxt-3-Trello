...
<template>
  <Disclosure as="nav" class="bg-white hover:shadow-[0_20px_8px_0px_rgba(0,0,0,1)]" v-slot="{ open }">
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex">
          <div class="flex-shrink-0 flex items-center">
            <img
              class="block lg:hidden h-5.5 w-auto"
              :src="trello"
              alt="Workflow"
            />
            <img
              class="hidden lg:block h-5.5 w-auto"
              :src="trello"
              alt="Workflow"
            />
          </div>
...
import trello from "@/assets/svg/Trello.svg?url";
</script>
